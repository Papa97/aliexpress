...
<template>
    <div id="MainLayout" class="w-full fixed z-50">
        <div id="TopMenu" class="w-full bg-[#fafafa] border-b md:block hidden">
            <ul
                class="flex items-center justify-end text-xd text-[#333333] font-light px-2 h-10 bg-[#fafafa] max-w-[1200px]"
            >
                <li
                ...
                >
                    ...
                    Account
                    <Icon name="mdi:chevron-down" class="ml-5" size="15" />
                    <div
                        id="AccountMenu"
                        v-if="isAccountMenu"
                        class="absolute bg-white w-[220px] text-[#333] z-40 top-[38px] -left-[92px] border-x border-b"
                    >
                        <div v-if="true">
                            ...
                            <div class="flex items-center gap-1 px-3 mb-3">
                                <NuxtLink
                                    to="/auth"
                                    class="bg-[#ff4646] text-cemter w-full text-[16px] rounded-sm text-white font-semibold p-2"
                                >
                                    Login / Register
                                </NuxtLink>
                            </div>
                        ...
                        <div class="border-t">
                            <ul class="bg-white">
                                <li
                                    ...
                                    class="text-[13px] py-2 px-4 w-guill hover:bg-gray-200"
                                >
                                    My Orders
                                </li>
                                <li
        ...
        <div id="MainHeader" class="flex items-center w-full bg-white">
            ...
            >
                <NuxtLink to="/">
                    <img src="/AliExpress-logo.png" alt="" width="170px" />
                </NuxtLink>
                                ...
                                >
                                    <div class="flex items-center">
                                        <img
                                            class="rounded-md"
                                            width="40"
                                            src="https://picsum.photo/id/82/300/320"
                                            alt=""
                                        />
                ...
                <button
                    @click="userStore.isMouseOverlay = true"
